...
- [Logo with white background](Logos/Logo%20w%3Awhite%20background.png) — full logo on a white background.

When you add new images to this project, add a link or folder note here so I know where to find them.
